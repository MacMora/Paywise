                    ...
                    <div className='font-code text-sm italic text-[#495059] py-2'>
                        ...
                        <div className="border-b-2 py-4">
                            <div onClick={() => handleClick("currency_pair")} className='flex flex-row gap-2 items-center cursor-pointer'>
                                ...
                                <p className='font-semibold'>currency_pair <span className='font-cabin text-[#8D9298] font-normal'>string</span></p>
                            </div>
                            {openSections["currency_pair"] && (
                                <div className='py-3'>
                                    <p className='py-2'><span className='font-semibold not-italic font-cabin'>Description:</span> The trading pair. Trading codes from ISO 4217. Example "USD"</p>
                        ...
                        <div className="border-b-2 py-4">
                            <div onClick={() => handleClick("rate_type")} className='flex flex-row gap-2 items-center cursor-pointer'>
                                ...
                                <p className='font-semibold'>rate_type <span className='font-cabin text-[#8D9298] font-normal'>string</span></p>
                            </div>
                            {openSections["rate_type"] && (
                                <div className='py-3'>
                                    <p className='py-2'><span className='font-semibold not-italic font-cabin'>Description:</span> Enum = {`{buying, selling}`}. Default to "selling"</p>
                                    <p className='py-2'><span className='font-semibold not-italic font-cabin'>Requirement:</span> mandatory</p>
                    ...
                    <div className='flex flex-col gap-2 font-code text-sm italic text-[#495059] py-2'>
                        ...
                        <div className="border-b-2 py-4">
                            ...
                            {openSections["message"] && (
                                <div className='py-3'>
                                    <p className='py-2'><span className='font-semibold not-italic font-cabin'>Description:</span> Messages will show based on condition applied. Added one example only. Example: {`"{Date's}: {rate}"`}</p>
                                    <p className='py-2'><span className='font-semibold not-italic font-cabin'>Requirement:</span> Mandatory</p>
