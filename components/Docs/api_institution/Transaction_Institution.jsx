                        ...
                        <div className='flex flex-col gap-2 font-code text-sm italic text-[#495059] py-2'>
                            ...
                            <div className="border-b-2 py-4">
                                ...
                                {openSections["transaction_id"] && (
                                    <div className="py-3">
                                        <p className="py-2"><span className="font-semibold not-italic font-cabin">Description:</span> Unique transaction id / number generated by Institution to uniquely identify this transaction.</p>
                                        <p className="py-2"><span className="font-semibold not-italic font-cabin">Requirement:</span> Mandatory</p>
                                        <p className="py-2"><span className="font-semibold not-italic font-cabin">Field Length:</span> 1 - 200</p>
                                    </div>
                                )}
                            </div>
                            <div className="border-b-2 py-4">
                                    ...
                                    <div className="py-3">
                                        ...
                                        <div className="border-b-2 px-2 py-4">
                                            ...
                                            {openSections["currency_quote_post"] && (
                                                <div className="py-3">
                                                    <p className="py-2"><span className="font-semibold not-italic font-cabin">Description:</span> Currency in ISO 4217 format. Example "USD"</p>
                                                    <p className="py-2"><span className="font-semibold not-italic font-cabin">Requirement:</span> Mandatory</p>
                                                    <p className="py-2"><span className="font-semibold not-italic font-cabin">Field Length:</span> 3</p>
                                                </div>
                                            )}
                                    ...
                                    <div className="py-3">
                                        ...
                                        <div className="border-b-2 px-2 py-4">
                                            ...
                                            {openSections["organization_id_quote_post_2"] && (
                                                <div className="py-3">
                                                    <p className="py-2"><span className="font-semibold not-italic font-cabin">Description:</span> Full name of the receiving organization. Example: "PayWise"</p>
                                                    <p className="py-2"><span className="font-semibold not-italic font-cabin">Requirement:</span> Optional</p>
                                                    <p className="py-2"><span className="font-semibold not-italic font-cabin">Field Length:</span> 30</p>
                                                </div>
                                            )}
                                                ...
                                                <div className="py-3">
                                                    ...
                                                    <div className="border-b-2 px-2 py-4">
                                                        ...
                                                        {openSections["id_type"] && (
                                                            <div className="py-3">
                                                                <p className="py-2"><span className="font-semibold not-italic font-cabin">Description:</span> ID document type of account holder used in sign up. Enum = {`NationalIdCard, Passport, DriversPermit, SSN, SIN, Other`}. Example: "Passport"</p>
                                                                <p className="py-2"><span className="font-semibold not-italic font-cabin">Requirement:</span> Mandatory</p>
                        ...
                        <div className='flex flex-col gap-2 font-code text-sm italic text-[#495059] py-2'>
                            ...
                            <div className="pt-4">
                                ...
                                {openSections["institution_receipt_id"] && (
                                    <div className='py-3'>
                                        <p className='py-2'><span className='font-semibold not-italic font-cabin'>Description:</span> The unique PayWise ID returned once the transaction has been posted.</p>
                                        <p className='py-2'><span className='font-semibold not-italic font-cabin'>Requirement:</span> Conditional</p>
