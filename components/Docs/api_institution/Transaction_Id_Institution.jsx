                    ...
                    <div className='font-code text-sm italic text-[#495059] py-2'>
                        ...
                        <div className="border-b-2 py-4">
                            ...
                            {openSections["transaction_id_get"] && (
                                <div className="py-3">
                                    <p className="py-2"><span className="font-semibold not-italic font-cabin">Description:</span> Using the Institution Encrpyted key, encrypt the unique transaction ID / number used in the POST.</p>
                            ...
                            {openSections["transaction"] && (
                                <div className='py-3'>
                                    ...
                                    <div className="px-2 border-b-2 py-4">
                                        ...
                                        {openSections["id"] && (
                                            <div className='py-3'>
                                                <p className='py-2'><span className='font-semibold not-italic font-cabin'>Description:</span> Institution friendly transaction id.</p>
                                                <p className='py-2'><span className='font-semibold not-italic font-cabin'>Requirement:</span> Mandatory</p>
