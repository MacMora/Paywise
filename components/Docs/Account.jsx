            ...
            <div className='lg:w-2/5 w-full'>
                            ...
                            <div className='border-b border-[#6FA43A] py-4'>
                                ...
                                <div className='flex flex-col gap-2 font-code text-sm italic text-[#495059] py-2'>
                                    ...
                                    <div className= "border-b-2 py-4">
                                        <div onClick={() => toggleVisibility("account_institution_name")} className='flex flex-row gap-0.5 items-center cursor-pointer'>
                                            <svg width="14" height="14" viewBox="0 0 192 336" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M24 24L168 168L24 312" stroke="#536374" stroke-width="48" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                                    ...
                                    <div className= "border-b-2 py-4">
                                        <div onClick={() => toggleVisibility("account_first_name")} className='flex flex-row gap-0.5 items-center cursor-pointer'>
                                            <svg width="14" height="14" viewBox="0 0 192 336" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M24 24L168 168L24 312" stroke="#536374" stroke-width="48" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                                    ...
                                    <div className= "border-b-2 py-4">
                                        <div onClick={() => toggleVisibility("account_last_name")} className='flex flex-row gap-0.5 items-center cursor-pointer'>
                                            <svg width="14" height="14" viewBox="0 0 192 336" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M24 24L168 168L24 312" stroke="#536374" stroke-width="48" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                                    ...
                                    <div className= "border-b-2 py-4">
                                        <div onClick={() => toggleVisibility("sender_first_name")} className='flex flex-row gap-0.5 items-center cursor-pointer'>
                                            <svg width="14" height="14" viewBox="0 0 192 336" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M24 24L168 168L24 312" stroke="#536374" stroke-width="48" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                                    ...
                                    <div className= "pt-4">
                                        <div onClick={() => toggleVisibility("sender_last_name")} className='flex flex-row gap-0.5 items-center cursor-pointer'>
                                            <svg width="14" height="14" viewBox="0 0 192 336" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M24 24L168 168L24 312" stroke="#536374" stroke-width="48" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                            ...
                            <div className='border-b border-[#6FA43A] py-4'>
                                ...
                                <div className='flex flex-col gap-2 font-code text-sm italic text-[#495059] py-2'>
                                    ...
                                    <div className= "border-b-2 py-4">
                                        <div onClick={() => toggleVisibility("account_status")} className='flex flex-row gap-0.5 items-center cursor-pointer'>
                                            <svg width="14" height="14" viewBox="0 0 192 336" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M24 24L168 168L24 312" stroke="#536374" stroke-width="48" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
