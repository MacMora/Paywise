...
export default function Plugin_Docs({ showWooCommerce }){
    return(
        <div className='main-content absolute top-12 left-0 lg:left-80 right-0 bottom-0 py-8 lg:py-20 px-4 lg:px-8 overflow-y-auto custom-scrollbar'>
            <div className='bg-[#F6F9FC] rounded-3xl overflow-hidden flex flex-col lg:flex-row justify-between items-center'>
                ...
                <div className='lg:basis-1/2 max-lg:py-8 w-full'>
                    <img className='w-full h-full object-cover' src="/images/woocommerce/3d-shapes.png" />
                </div>
            </div>
            <div className='flex flex-col lg:flex-row justify-around items-center py-8 shadow-lg'>
