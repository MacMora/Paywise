...
const Codes = () => {
    ...
    const renderSection = (title, content) => (
        <div className="bg-[#3e444f] rounded-xl mb-4">
    ...
    return (
        <div className='absolute top-12 left-80 right-0 bottom-0 py-20 pl-8 pr-8 overflow-y-auto custom-scrollbar'>
            <h1 className='text-6xl py-5 font-bold'>Paywise API</h1>
            <div id="api_reference" className='flex flex-row justify-around items-center py-20 border-y-2'>
                <div className='w-2/5'>
            ...
            <div id="authentication" className='flex flex-row justify-around items-center py-12 border-b-2'>
                <div className='w-2/5'>
            ...
            <div id="connected_accounts" className='flex flex-row justify-around items-center py-12 border-b-2'>
                <div className='w-2/5'>
            ...
            <div id="errors" className='flex flex-row justify-around items-center py-12 border-b-2'>
                <div className='w-2/5'>
                    <h2 className='text-3xl font-semibold'>Errors</h2>
                    <p className='py-5 text-base'>
