                ...
                <div className="lg:w-5/5 w-full">
                    ...
                    <div id="quick_start" className="py-8">
                        ...
                        <ol className="text-sm">
                            <li>
                                1. To call our endpoints, you need to have a valid subscription. Follow these steps to activate your subscription:
                                <ol className="p-4">
                                    <li>
                                        I. <a href="https://devportal.paywise.co/signup" target="_blank">Sign up</a> on the <a href="https://devportal.paywise.co" target="_blank">Developer Portal</a> and verify your email.
                                    </li>
                                    <li>
                                        II. Once verified, sign in and create a subscription in your <a href="https://devportal.paywise.co/profile" target="_blank">Profile page.</a> You can copy your subscription key (`pw-subscription-key`) from your Profile. This subscription is automatically active in this environment.
                                    </li>
                                </ol>
                            </li>
                            <li>
